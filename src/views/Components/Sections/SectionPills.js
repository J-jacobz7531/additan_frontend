 ...
 <div className="container">
    <div className={classes.section}>
      <div className={classes.container}>
        ...
        <div >
          <div className={classes.title}>
            <h3 style={{ paddingTop:'30px'}}>Welcome to Ad-ditans Platform!</h3>
          </div>
        </div>
          <div className={classes.title}>
            <h3>
            ...
            <p>
              The Ad-ditans Platform seeks to empower people  
             in different ways! That is, connect people who are in dire need to invest but lack mentorship and adequate resources to
              a possible mentor and like minded investors near them.For more information 
              about the Power of Ad-ditans, please read through the "For Better Expericence Section"..
              Enjoy.  </p>
          </div>
          <GridContainer>
      ...
      <GridContainer justify="center">
        ...
        <label >Your Current Location Details.</label> 
         ...
         <div class="form-group">
           ...
           <div class="form-group">
           <label >Number of investors(3 to 7)</label>
            ...
            <GridItem xs={12} sm={12} md={4}>
                  ...
                  },
                  {
                    ...
                    tabContent: (
                      <span>
                        <p>
                          Enabling your Location enables Ad-ditans platform to get your location details automatically.
                          After this, go back to the Ad-ditans form and fill in the other Information required.
                        </p>
                        <br />
      ...
      <div className={classes.container}>
        <div id="nav-tabs">
        <br/><br/>
          <h3>Potential investor Details</h3>
          <GridContainer>
            <GridItem xs={12} sm={12} md={12}>
              <h5 style={{ 'fontSize': '15px'}}>
               This section gives detailed Information about the investors 
                in your vicinity. Note that the list gives investors in Order, that is
                      ...
                      <div class="results">
                       {
                         this.state.results.length > 0 ? (
                          <div>
                            ...
                            <br />
                            <label >Description of their investment :   </label>  <br />
                            ...
                            <br />
                            <label >Other relevant Info about the Investors :  </label>  <br />
